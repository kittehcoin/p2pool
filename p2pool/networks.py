...
nets = dict(
    ...
    kittehcoin=math.Object(
        ...
        SPREAD=12, # blocks
        IDENTIFIER='5bd1c1af532dde46'.decode('hex'),
        PREFIX='323fbbc9bb3cbf6f'.decode('hex'),
        P2P_PORT=9445,
        MIN_TARGET=0,
        MAX_TARGET=2**256//2**20 - 1,
        PERSIST=True,
        WORKER_PORT=9444,
        BOOTSTRAP_ADDRS='stella.dnsalias.com'.split(' '),
    ...
    kittehcoin_testnet=math.Object(
        ...
        TARGET_LOOKBEHIND=500, # shares
        SPREAD=12, # blocks
        IDENTIFIER='5ed5c7af532dde46'.decode('hex'),
        PREFIX='323fbcc9bb34bf65'.decode('hex'),
        P2P_PORT=9445,
        MIN_TARGET=0,
        MAX_TARGET=2**256//2**20 - 1,
        PERSIST=False,
