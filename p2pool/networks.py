...
nets = dict(
    ...
    kittehcoin=math.Object(
        ...
        PERSIST=True,
        WORKER_PORT=9566,
        BOOTSTRAP_ADDRS='taken.pl lovok.no-ip.com meow-il.zapto.org p2pool-eu.gotgeeks.com p2pool-us.gotgeeks.com rav3n.dtdns.net p2pool.gotgeeks.com p2pool.dtdns.net solidpool.org'.split(' '),
        ANNOUNCE_CHANNEL='#p2pool-alt',
    ...
    kittehcoin_testnet=math.Object(
        ...
        TARGET_LOOKBEHIND=20, # shares
        SPREAD=50, # blocks
        IDENTIFIER='c0c1c2e3f6f9f1bb'.decode('hex'),
        PREFIX='f1c3a9a0a3e0c047'.decode('hex'),
        P2P_PORT=9445,
        MIN_TARGET=0,
        MAX_TARGET=2**256//2**20 - 1,
        PERSIST=False,
