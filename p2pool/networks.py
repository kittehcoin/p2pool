...
nets = dict(
    ...
    kittehcoin=math.Object(
        ...
        PERSIST=True,
        WORKER_PORT=9566,
        BOOTSTRAP_ADDRS='taken.pl lovok.no-ip.com p2pool-eu.gotgeeks.com p2pool-us.gotgeeks.com rav3n.dtdns.net p2pool.gotgeeks.com p2pool.dtdns.net solidpool.org'.split(' '),
        ANNOUNCE_CHANNEL='#p2pool-alt',
